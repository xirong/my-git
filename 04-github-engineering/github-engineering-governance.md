...
更完整的组合方式见 [企业 GitHub 协作配置栈](enterprise-github-workflow-stack.md)。
...
如果团队已经把配置、基础设施或发布策略纳入仓库管理，可以继续阅读 [GitOps and Config as Code](gitops-and-config-as-code.md)。这类实践会把 PR、Review、CODEOWNERS、CI 校验和发布审计扩展到代码之外。
